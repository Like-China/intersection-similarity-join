...
public class ParallelBallTreeEvaluation {
    ...
    public ParallelBallTreeEvaluation(ArrayList<Data> queries, ArrayList<Data> db, int minLeafNB) {
    ...
    public ArrayList<ContactPair> getCandidate() {
        ...
        fTime = t2 - t1;
        // System.out.printf("Construction time: %7d Filter time:%7d**BallTreePara**\n",
        // cTime, fTime);
        return candidates;
    }
