...
public class Settings {
        ...
        public static int sampleNum = 50;
        // the number of threads if multi-threading is emplyed
        public static int threadNB = 5;
        ...
        public static int cardinality = (data == "Geolife") ? 10000 : 20000;
        public static int[] cardinalities = (data == "Geolife") ? new int[] { 500000 }
